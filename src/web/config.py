...
class Config(object):
  ...
  AWS_SNS_JOB_REQUEST_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:katherinezh_job_requests"
  AWS_SNS_JOB_COMPLETE_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:katherinezh_job_results"
  
  AWS_SQS_JOB_ARCHIVE_QUEUE_URL = \
  "https://sqs.us-east-1.amazonaws.com/659248683008/katherinezh_job_archives"
  AWS_SQS_JOB_RESTORE_QUEUE_URL = \
    "https://sqs.us-east-1.amazonaws.com/659248683008/katherinezh_job_restore"

  # Change the table name to your own
  AWS_DYNAMODB_ANNOTATIONS_TABLE = "katherinezh_annotations"
  AWS_DYNAMODB_ANNOTATIONS_TABLE_INDEX_NAME = "user_id_index"

  # Change the email address to your username
  MAIL_DEFAULT_SENDER = "katherinezh@mpcs-cc.com"
